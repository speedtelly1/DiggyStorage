...
const items = [
    ...
    },
    {
        id: 20,
        title: "ИТД",
        shortDescription: "ИТД — это новая гибридная платформа (соцсеть x форум) от блогера Новки, запущенная 16 декабря 2025 года. Её отличает меметичная культура, клановая система, акцент на публичных дискуссиях и быстрое внедрение фич, формируемые первыми пользователями из ядра Telegram-аудитории создателя.",
